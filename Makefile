...
doc/*.html: APNs.js GCM.js WNS.js config.js loggerUtils.js notifier.js payloadGenerator.js registrar.js \
	registrationStore.js server.js templateManager.js templateStore.js Makefile
	if [ -n "${JSDOCDIR}" ]; then \
